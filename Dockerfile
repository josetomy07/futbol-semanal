...
# Set timezone and install necessary dependencies
RUN ln -snf /usr/share/zoneinfo/$TZ /etc/localtime && echo $TZ > /etc/timezone

# Update and install system dependencies along with PHP extensions
RUN apt-get update \
...
# Add user and group for sail
RUN groupadd --force -g $WWWGROUP sail
RUN useradd -ms /bin/bash --no-user-group -g $WWWGROUP -u 1337 sail

# Copy necessary files for the container setup
